...
file = './dataset/2matrix_2-5_3-6.mat'
...
# for i in range(10001):
    ...
    # loss1 = torch.mean((alpha[0]*d2u1dx2+beta[0]*du1dx+gamma[0]*physic_output1-du1dt)**2+(alpha[1]*d2u2dx2+beta[1]*du2dx+gamma[1]*physic_output2-du2dt)**2)
...
torch.save(pinn,"./model/18060424.pkl.")
time_end = time.time()
...
# plt.hlines(7, 0, len(gams1), label="True value", color="tab:green")
# plt.legend()
# plt.xlabel("Training step")
# plt.show()
