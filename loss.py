...
def pde_loss(t_batch):
    ...
    return loss_func(t_batch['zero'],zero)
...
# #     def du_dt(self,t_batch):
# #         return gradient.gradient(t_batch['u_hat'],t_batch['t'])
    
# #     def du_dx(self,t_batch):
# #         return gradient.gradient(t_batch['u_hat'],t_batch['x'])
    
# #     def d2u_d2x(self,t_batch):
# #         dudx = self.du_dx(t_batch)
# #         return gradient.gradient(dudx,t_batch['x'])
    
# #     def zerotensor(self,t_batch):
# #         length = len(t_batch['u_hat'])
